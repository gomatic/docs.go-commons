# `docs.go-commons` — public documentation repository

This is the **public** documentation site for [`gomatic/go-commons`](https://github.com/gomatic/go-commons), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-commons`](https://github.com/gomatic/go-commons)'s API changes, update [`content/`](../content/) to match.
